...
/**
 * The {@link Visualize} class will take the result from the kmeans algorithm
 * and created a colored diagram of the layout of the plane.
 * 
...
public class Visualize extends JFrame {
	...
	/**
	 * The constructor for this method will take the clustered result of the
	 * kmeans algorithm
	 * 
	 * @param clusters
	 */
	...
	/**
	 * To make the {@link Visualize} more robust we are going to randomly
	 * generate a certain number of unique colors.
	 * 
	 * @param size
	 */
	...
	/**
	 * This {@link JPanel} will display colored squares with axis for rows and
	 * ailses.
	 * 
	 * @author Nathaniel Cotton
	 * 
	...
	class Squares extends JPanel {
		protected void paintComponent(Graphics g) {
			...
			g2.drawOval((8 - 1) * squareDim, (7 - 1) * squareDim, squareDim,
					squareDim);
			g2.drawOval((3 - 1) * squareDim, (42 - 1) * squareDim, squareDim,
					squareDim);
		}
	}
